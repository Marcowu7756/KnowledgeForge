...
| `md` | ingest_file | run_file→card | ko_animate | **pass** | ko=<pytest_tmp>/test_source_settle_express_mat0/packages/matrix_note_md_094240764910/knowledge_object.json |
...
| `audio` | ingest_audio(mock ASR) | run_audio→card | ko_narrate_mock | **pass** | wav=<pytest_tmp>/test_source_settle_express_mat0/packages/matrix_talk_audio_094246436082/narration.wav |
